...
import { LowCodeRadioPropsType, OptionType } from './interface'

const PropComponent: FC<LowCodeRadioPropsType> = (props: LowCodeRadioPropsType) => {
  ...
  function handleValuesChange() {
    ...
    // 触发 onChange 函数
    const newValues = form.getFieldsValue() as LowCodeRadioPropsType
